...
int main(){
    ...
    superpoder1 = populacao1 + areaemkm1 + pib1 + pibpercapita1 + densidade1;

    printf ("A carta 1 tem : %d pontos de Super poder!\n", superpoder1);
    ...
    superpoder1 = populacao2 + areaemkm2 + pib2 + pibpercapita2 + densidade2;
    printf ("A carta 2 tem : %d pontos de Super poder!\n", superpoder2);
...
printf ("\n");
    ...
    printf ("Agora para os vencedores, saiba que : '1' = A venceu e '0' = B venceu\n");
    printf ("A cidade com maior população é : %d\n", populacao1 > populacao2);
    printf ("A cidade com maior km² é: %d\n", areaemkm1 > areaemkm2 );
    printf ("A cidade com maior PIB é : %d\n", pib1 > pib2 );
    printf ("A cidade com maior numero de pontos turisticos é: %d\n", numeropontosturisticos1 > numeropontosturisticos2);
    printf ("A cidade com o maior PIB per capita é: %d\n", pibpercapita1 > pibpercapita2);
    printf ("A cidade com maior densidade populacional é: %d\n", densidade1 > densidade2);
    printf ("A carta com maior Super poder é : %d\n", superpoder1 > superpoder2);
